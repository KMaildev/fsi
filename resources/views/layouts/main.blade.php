...
<head>
    ...
    <meta name="keywords" content="Fore Signal Int'l Services Co.,Ltd" />
    <meta name="author" content="Fore Signal Int'l Services Co.,Ltd" />
    <meta name="robots" content="Fore Signal Int'l Services Co.,Ltd" />
    <meta name="description" content="Fore Signal Int'l Services Co.,Ltd" />
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="{{ route('home') }}" aria-label="logo image">
                    <img src="{{ asset('data/weblogo.png') }}" alt="" style="width: 250px;" />
                </a>
            </div>
            <!-- /.logo-box -->
